...
function init(app, notebook, tracker, settingRegistry) {
    ...
    const buttonCreateRemoveExercise = new _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_3__.ToolbarButton({
        className: 'myButton',
        iconClass: 'fa fa-sm fa-eye-slash fontawesome-colors',
        onClick: () => { create_remove_exercise(notebook, tracker, tool); },
        tooltip: 'Create/Remove Exercise',
    });
}
;
/**
...
//# sourceMappingURL=lib_index_js.3346dbc0655cc444cdfa.js.map