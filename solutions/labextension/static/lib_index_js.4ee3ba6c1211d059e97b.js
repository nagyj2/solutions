...
function create_remove_exercise(notebook, tracker, metadata) {
    ...
    if (metadata.checkApplied('first')) { // If removing the first of an exercise, remove entire exercise
        ...
        (_d = maps.get(lcells[0].id)) === null || _d === void 0 ? void 0 : _d.forEach(cell => {
            cell.show();
        });
        ...
        maps.set(lcells[0].id, lcells); // Add the cell to the map
        //add_element(cell)
        for (var i = 1; i < lcells.length; i++) {
            _jupyterlab_notebook__WEBPACK_IMPORTED_MODULE_1__.NotebookActions.selectBelow((_e = tracker.currentWidget) === null || _e === void 0 ? void 0 : _e.content);
...
//# sourceMappingURL=lib_index_js.4ee3ba6c1211d059e97b.js.map